...
async function seed() {
  ...
  const seedUmkms = [
    {
      ...
      categoryId: 1,
      description: "Produk olahan ikan bandeng presto dan cabut duri kualitas super dari pesisir Desa Korowelang Kulon. Gurih, bebas duri, dan higienis.",
      address: "RT 02 / RW 01, Desa Korowelang Kulon, Kec. Cepiring",
      dusun: "Krajan 1",
    ...
    {
      name: "Batik Kendalisada Korowelang",
      slug: "batik-kendalisada-korowelang",
      ownerName: "Hj. Mutmainah",
      categoryId: 2,
      description: "Sentra kerajinan batik tulis & cap khas pesisir Kendal dengan pewarna alam ramah lingkungan dan motif biota laut Korowelang.",
      address: "RT 05 / RW 02, Desa Korowelang Kulon",
      dusun: "Krajan 2",
      ...
      instagramUrl: "https://instagram.com/batikkorowelang",
    ...
    },
    {
      ...
      address: "RT 01 / RW 03, Desa Korowelang Kulon",
      dusun: "Nologaten",
  ...
  const seedProducts = [
    ...
    },
    {
      ...
      description: "Olahan daging bandeng rempah gurih khas Korowelang",
      price: "35000.00",
    ...
    },
    {
      ...
      description: "Kain batik katun halus pewarna alami khas Desa Korowelang Kulon",
      price: "250000.00",
      imageUrl: "https://images.unsplash.com/photo-1606744888344-493238951221?auto=format&fit=crop&w=800&q=80",
    },
  ];
